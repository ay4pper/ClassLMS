	...
	add_action(
		...
		function() {
			printf(
				...
				esc_html( 'Masteriyo:' ),
				wp_kses_post( 'Elementor Integration addon requires Elementor plugin to be installed and activated.', 'learning-management-system' ),
...
if ( ! Helper::is_elementor_active() ) {
	add_filter(
		...
		function ( $result, $request, $controller ) {
			$result = __( 'Elementor plugin needs to be installed and activated for this addon to work properly', 'learning-management-system' );
			return $result;
		},
		10,
		3
