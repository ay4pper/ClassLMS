<?php
/**
 * Course start to instructor email class.
 *
...
class CourseStartEmailToInstructor extends Email {
	 ...
	 * @var string
	 */
	protected $id = 'course-start/to/instructor';
	 ...
	 * @var string
	 */
	protected $html_template = 'emails/instructor/course-start.php';
	...
	public function is_enabled() {
		return masteriyo_string_to_bool( masteriyo_get_setting( 'emails.instructor.course_start.enable' ) );
	}
	...
	public function get_subject() {
		 ...
		 */
		$subject = apply_filters( $this->get_full_id(), masteriyo_get_default_email_contents()['instructor']['course_start']['subject'] );
	...
	public function get_heading() {
		 ...
		 */
		$heading = apply_filters( $this->get_full_id() . '_heading', masteriyo_get_setting( 'emails.instructor.course_start.heading' ) );
	...
	public function get_additional_content() {
		 ...
		 */
		$additional_content = apply_filters( $this->get_full_id() . '_additional_content', masteriyo_get_setting( 'emails.instructor.course_start.additional_content' ) );
		$additional_content = masteriyo_string_translation( 'emails.instructor.course_start.additional_content', 'masteriyo-email-message', $additional_content );
	...
	public function get_content() {
		$content = masteriyo_string_translation( 'emails.instructor.course_start.content', 'masteriyo-email-message', masteriyo_get_default_email_contents()['instructor']['course_start']['content'] );
