<?php
/**
 * Course start email to instructor.
 *
 * This template can be overridden by copying it to yourtheme/masteriyo/emails/instructor/course-start.php.
 *
 ...
 * @since 1.15.0
 *
 * @param \Masteriyo\Emails\Instructor\CourseStartEmailToInstructor $email Email object.
 */
