<?php
/**
 * Withdraw request rejected email to instructor.
 *
 * This template can be overridden by copying it to yourtheme/masteriyo/emails/instructor/withdraw-request-rejected.php.
 *
