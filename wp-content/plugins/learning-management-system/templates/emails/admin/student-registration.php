<?php
/**
 * Student registration email to admin.
 *
 * This template can be overridden by copying it to yourtheme/masteriyo/emails/admin/student-registration.php.
 *
 ...
 * @since 1.15.0
 *
 * @param \Masteriyo\Emails\Admin\StudentRegistrationEmailToAdmin $email Email object.
 */
