<?php
/**
 * Instructor registration email to admin.
 *
 * This template can be overridden by copying it to yourtheme/masteriyo/emails/admin/instructor-registration.php.
 *
 ...
 * @since 1.15.0
 *
 * @param \Masteriyo\Emails\Admin\InstructorRegistrationEmailToAdmin $email Email object.
 */
