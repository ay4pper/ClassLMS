<?php
/**
 * Course completion email to admin.
 *
 * This template can be overridden by copying it to yourtheme/masteriyo/emails/admin/course-completion.php.
 *
 ...
 * @since 1.15.0
 *
 * @param \Masteriyo\Emails\Admin\CourseCompletionEmailToAdmin $email Email object.
 */
