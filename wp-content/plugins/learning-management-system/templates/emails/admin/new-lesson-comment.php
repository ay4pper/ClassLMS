<?php
/**
 * New lesson comment notification email to admin.
 *
 * This template can be overridden by copying it to yourtheme/masteriyo/emails/admin/new-lesson-comment.php.
 *
 ...
 * @since x.x.x
 *
 * @param \Masteriyo\Emails\Admin\NewLessonCommentEmailToAdmin $email Email object.
 */
