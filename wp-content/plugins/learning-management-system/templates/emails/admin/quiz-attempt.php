<?php
/**
 * Quiz Attempt email to admin.
 *
 * This template can be overridden by copying it to yourtheme/masteriyo/emails/admin/quiz-attempt.php.
 *
 ...
 * @since 1.15.0
 *
 * @param \Masteriyo\Emails\Admin\NewQuizAttemptEmailToAdmin $email Email object.
 */
