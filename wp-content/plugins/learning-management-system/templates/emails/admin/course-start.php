<?php
/**
 * Course start email to admin.
 *
 * This template can be overridden by copying it to yourtheme/masteriyo/emails/admin/course-start.php.
 *
 ...
 * @since 1.15.0
 *
 * @param \Masteriyo\Emails\Admin\CourseStartEmailToAdmin $email Email object.
 */
