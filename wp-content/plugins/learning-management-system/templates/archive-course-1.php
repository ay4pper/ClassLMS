 ...
 *
 * This template can be overridden by copying it to yourtheme/masteriyo/archive-course-1.php.
 *
...
if ( $enable_custom_template && $template_source && $template_id ) {
	...
	<div class="masteriyo-course-list-display-section layout_1" data-layout="layout_1">
	...
	if ( masteriyo_course_loop() ) {
		...
		masteriyo_course_loop_start( true, 'loop/loop-start-1.php' );
...
masteriyo_get_template( 'course-password-modal.php' );
